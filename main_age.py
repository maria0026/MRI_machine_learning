...
def main(args):
    ...
    for i in range(args.n_crosval):
        ...
        if args.model_name=='forest':
            rf = train.random_forrest_regression_model(X_train, y_train, args.forest_param_dist, *feature)
            ...
            clf = train.svm_regression_model(X_train, y_train, args.svm_param_dist)
