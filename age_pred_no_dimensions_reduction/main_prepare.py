...
def main(args):
    ...
    for i, filepath in enumerate(args.path):
        ...
        folder_out=f'data/preprocessed_atlas_big/{args.data_type}_norm_confirmed_{atlas}'
        if i==0:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", nargs="?", default=['data/original_atlas_big/a2009'], help="Path to the folder where the original files are", type=list)
