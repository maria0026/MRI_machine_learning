...
def main(args):
    ...
    atlas=os.path.split(args.path)[-1]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", nargs="?", default="data/original_atlas/ASEG", help="Path to the folder where the original files are", type=str)
