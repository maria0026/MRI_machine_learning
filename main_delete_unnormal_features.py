...
filename='data_4/test_data_all/all_concatenated.csv'
...
folder='data_4/test_data'
folder_out='data_4/test_data_normal'
prepare_dataset.detele_unnormal_columns(folder, folder_out, df_outliers)
...
folder='data_4/test_data_normal'
folder_out='data_4/test_data_normal'
prepare_dataset.detele_unnormal_columns(folder, folder_out, df_outliers)


'''
folder='data_4/test_data_all'
folder_out='data_4/all'
prepare_dataset.detele_unnormal_columns(folder, folder_out, df_outliers)
'''