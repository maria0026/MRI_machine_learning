...
#uwuwanie duplikatów subjectów, brakujących danych i danych z norm_confirmed=1 na podstwaie Subjects.csv
filename='Subjects.csv'
indexes=prepare_csv.get_indexes_for_cleaning_dataset(folder, filename, data_files=False, norm_confirmed=0)
...
folder_out='data_4/test_data_all'
folder_out='data_4/test_data'
